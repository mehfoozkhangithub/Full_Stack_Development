...
export const EDITS_TODO_REQUEST = 'EDITS_TODO_REQUEST';
export const EDITS_TODO_SUCCESS = 'EDITS_TODO_SUCCESS';
export const EDITS_TODO_FAILURE = 'EDITS_TODO_FAILURE';
