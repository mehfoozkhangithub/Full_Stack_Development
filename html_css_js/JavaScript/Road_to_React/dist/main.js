(() => {
  ...
  const l = (e) => ((e = e.toLowerCase()), (t) => a(t) === e),
    ...
    R = l('FileList'),
    S = l('URLSearchParams'),
    [T, A, v, j] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(l);
  ...
  const J =
    ...
    W = {
      ...
      isSpecCompliantForm: function (e) {
        return !!(e && m(e.append) && 'FormData' === e[i] && e[s]);
      },
      toJSONObject: (e) => {
  ...
  const Y = W.toFlatObject(W, {}, null, function (e) {
    ...
    ee = function (e, t, n) {
      ...
      function l(e, n, o) {
        ...
        return !!G(e) || (t.append(Z(o, n, s), c(e)), !1);
      }
      const u = [],
        f = Object.assign(Y, {
          defaultVisitor: l,
  ...
  function Re(e) {
    return !1 === e || null == e ? e : W.isArray(e) ? e.map(Re) : String(e);
  }
  ...
  const ke = (e) => (e instanceof Ae ? { ...e } : e);
  function De(e, t) {
    t = t || {};
    const n = {};
    function r(e, t, n, r) {
  ...
  const qe = (e) => {
      ...
      if (
        ...
        (o && W.isFunction(o) && (o = o(t)), o || (!1 !== o && _e(t.url)))
      ) {
    ...
    Me =
      ...
      function (e) {
        return new Promise(function (t, n) {
          const r = qe(e);
          let o = r.data;
          const s = Ae.from(r.headers).normalize();
          let i,
            a,
            c,
            l,
      ...
      if (t || n) {
        ...
        const o = function (e) {
          if (!n) {
            ...
            r.abort(
              t instanceof X ? t : new Ce(t instanceof Error ? t.message : t)
            );
          }
        };
        let s =
          t &&
          setTimeout(() => {
            (s = null), o(new X(`timeout ${t} of ms exceeded`, X.ETIMEDOUT));
          }, t);
        const i = () => {
          e &&
            (s && clearTimeout(s),
    ...
    We = Je && 'function' == typeof ReadableStream,
    Ke =
      Je &&
      ('function' == typeof TextEncoder
        ? ((Ve = new TextEncoder()), (e) => Ve.encode(e))
  ...
  const $e = (e, ...t) => {
    ...
    Ge = We && $e(() => W.isReadableStream(new Response('').body)),
    Qe = { stream: Ge && ((e) => e.body) };
  var Ze;
  Je &&
    ((Ze = new Response()),
    ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach((e) => {
      !Qe[e] &&
        (Qe[e] = W.isFunction(Ze[e])
          ? (t) => t[e]()
          : (t, n) => {
              throw new X(
    ...
    fetch:
      ...
      (async (e) => {
        ...
        try {
                  ...
                  ? (async (e) => {
                      ...
                      return W.isArrayBufferView(e) || W.isArrayBuffer(e)
                        ...
                        : (W.isURLSearchParams(e) && (e += ''),
                          W.isString(e) ? (await Ke(e)).byteLength : void 0);
                    })(t)
                  : n;
              })(u, r))
          ) {
          ...
          let s = await fetch(p);
          const i = Ge && ('stream' === l || 'response' === l);
          if (Ge && (a || (i && m))) {
            const e = {};
            ['status', 'statusText', 'headers'].forEach((t) => {
              e[t] = s[t];
            });
            const t = W.toFiniteNumber(s.headers.get('content-length')),
              [n, r] = (a && Ue(t, Pe(Fe(a), !0))) || [];
            s = new Response(
              He(s.body, 65536, n, () => {
                r && r(), m && m();
              }),
          ...
          l = l || 'text';
          let b = await Qe[W.findKey(Qe, l) || 'text'](s, e);
          return (
            !i && m && m(),
          ...
          if (
            ...
            throw Object.assign(new X('Network Error', X.ERR_NETWORK, e, p), {
              cause: t.cause || t,
            });
          throw X.from(t, t && t.code, e, p);
        }
      }),
  };
  W.forEach(Ye, (e, t) => {
  ...
  const et = (e) => `- ${e}`,
    tt = (e) => W.isFunction(e) || null === e || !1 === e,
    nt = (e) => {
      e = W.isArray(e) ? e : [e];
      const { length: t } = e;
      let n, r;
      ...
      for (let s = 0; s < t; s++) {
        ...
        if (
          ((n = e[s]),
          (r = n),
          !tt(n) && ((r = Ye[(t = String(n)).toLowerCase()]), void 0 === r))
        )
  ...
  function ot(e) {
    return (
      ...
      nt(e.adapter || ge.adapter)(e).then(
        function (t) {
          return (
            rt(e),
  ...
  const ht = pt,
    mt = (function e(t) {
      const r = new ut(t),
        o = n(ut.prototype.request, r);
      return (
        W.extend(o, ut.prototype, r, { allOwnKeys: !0 }),
  ...
  (mt.Axios = ut),
    ...
    (mt.mergeConfig = De),
    (mt.AxiosHeaders = Ae),
    (mt.formToJSON = (e) => ye(W.isHTMLForm(e) ? new FormData(e) : e)),
    (mt.getAdapter = nt),
